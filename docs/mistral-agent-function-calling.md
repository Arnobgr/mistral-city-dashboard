...
Built into our API, we provide [built-in tools](built-in) tools such as `websearch`, `code_interpreter`, `image_generation` and `document_library`. However, you can also use standard function tool calling by defining a JSON schema for your function.
...
<SectionTab as="h1" sectionId="creating-an-agent-with-function-calling">Creating an Agent</SectionTab>
...
<SectionTab as="h2" variant="secondary" sectionId="define-the-function">Define the Function</SectionTab>
...
<SectionTab as="h1" sectionId="using-an-agent-with-function-calling">Using an Agent</SectionTab>
...
<SectionTab as="h2" variant="secondary" sectionId="return-result">Return the Function Result</SectionTab>
