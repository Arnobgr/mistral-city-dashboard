    ...
    post:
      ...
      parameters:
        ...
        - name: output_format
          ...
          schema:
            $ref: >-
              #/components/schemas/type_textToSpeech:TextToSpeechConvertRequestOutputFormat
        - name: xi-api-key
          in: header
          required: false
          schema:
            ...
            schema:
              ...
              properties:
                ...
                apply_text_normalization:
                  $ref: >-
                    #/components/schemas/type_textToSpeech:BodyTextToSpeechFullApplyTextNormalization
                  description: >-
...
components:
  schemas:
    type_textToSpeech:TextToSpeechConvertRequestOutputFormat:
      type: string
      enum:
        - alaw_8000
        - mp3_22050_32
      ...
      title: TextToSpeechConvertRequestOutputFormat
    type_:VoiceSettings:
      type: object
      properties:
        stability:
    ...
    type_textToSpeech:BodyTextToSpeechFullApplyTextNormalization:
      type: string
      enum:
        - auto
        - 'on'
      ...
      description: >-
        ...
        it will be skipped.
      title: BodyTextToSpeechFullApplyTextNormalization
